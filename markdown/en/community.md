...
our [Governance](docs/governance.html) page.
...
Please remember our
[
Code of Conduct](https://github.com/nginx/nginx/blob/master/CODE_OF_CONDUCT.md)
(CoC) when participating in the NGINX community.

If you wish to tell us about a CoC violation,
please email us here:
[nginx-oss-community@f5.com](mailto://nginx-oss-community@f5.com)
...
- [
Browse a Source Code](https://github.com/nginx/nginx)
- [
Report a Bug](https://github.com/nginx/nginx/issues)
- [
Participate](docs/contributing_changes.html)
