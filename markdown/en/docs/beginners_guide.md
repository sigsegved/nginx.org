...
If it is not, see the [install.html](install.html) page.
...
[](ngx_core_module.xml#worker_processes)).
...
[](http/ngx_http_core_module.xml#server)
block inside the [](http/ngx_http_core_module.xml#http)
block with two [](http/ngx_http_core_module.xml#location)
blocks.
...
they [listen](http/ngx_http_core_module.xml#listen) to
and by
...
[](http/ngx_http_core_module.xml#root)
...
it first checks [](http/ngx_http_core_module.xml#location)
...
and [](http/ngx_http_fastcgi_module.xml#fastcgi_param)
