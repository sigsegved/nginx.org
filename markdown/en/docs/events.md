...
The following connection processing methods are supported:
  ...
  > **Note:** The `EPOLLRDHUP` (Linux 2.6.17, glibc 2.8)
and `EPOLLEXCLUSIVE` (Linux 4.5, glibc 2.24)
flags are supported since 1.11.3.

  > **Note:** Some older distributions like SuSE 8.2 provide patches
