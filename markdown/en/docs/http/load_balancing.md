...
All requests are
[
proxied](ngx_http_proxy_module.xml#proxy_pass) to the server group myapp1, and nginx applies HTTP load
...
[](ngx_http_memcached_module.xml#memcached_pass), and
...
[
least_conn](ngx_http_upstream_module.xml#least_conn) directive is used as part of the server group configuration:
...
[](ngx_http_upstream_module.xml#ip_hash)
...
When the
[weight](ngx_http_upstream_module.xml#server)
...
[](ngx_http_proxy_module.xml#proxy_next_upstream),
[backup](ngx_http_upstream_module.xml#server),
[down](ngx_http_upstream_module.xml#server), and
[](ngx_http_upstream_module.xml#keepalive).
