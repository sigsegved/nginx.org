...
> **Note:** IPv6 prefixes are supported starting from versions 1.3.10 and 1.2.7.
...
> **Note:** Trusted IPv6 addresses are supported starting from versions 1.3.0 and 1.2.1.
