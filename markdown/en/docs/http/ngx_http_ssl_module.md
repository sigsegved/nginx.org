...
the  directive should be set to
on or optional.
...
[](ngx_http_core_module.xml#error_page) directive:
...
[](ngx_http_proxy_module.xml#proxy_set_header) directive;
...
> **Note:** The variable is currently supported only when using OpenSSL
