...
by the [](ngx_http_proxy_module.xml#proxy_pass),
...
[](ngx_http_grpc_module.xml#grpc_pass) directives.
...
If the  parameter is specified for the server,
...
of the  directive to identify the server to which the
...
allows passing it
[through SNI](ngx_http_proxy_module.xml#proxy_ssl_server_name):
