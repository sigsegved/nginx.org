...
directive
and determine which [](ngx_http_core_module.xml#server) block
is used for a given request.
See also “[request_processing.html](request_processing.html)”.
...
header field in a [](ngx_http_core_module.xml#server)
...
If no
[](ngx_http_core_module.xml#server_name)
is defined in a [](ngx_http_core_module.xml#server) block
...
in the [](ngx_http_core_module.xml#server_name) directive:
...
- in case of the
[](ngx_http_ssl_module.xml#ssl_protocols) directive,
...
- the
[](ngx_http_core_module.xml#client_header_buffer_size)
and
[](ngx_http_core_module.xml#merge_slashes) directives
...
- in case of the
[](ngx_http_core_module.xml#ignore_invalid_headers),
[](ngx_http_core_module.xml#large_client_header_buffers),
and
[](ngx_http_core_module.xml#underscores_in_headers) directives
...
the [](ngx_http_core_module.xml#error_page) directive
...
the [](ngx_http_core_module.xml#server_names_hash_max_size)
and [](ngx_http_core_module.xml#server_names_hash_bucket_size)
