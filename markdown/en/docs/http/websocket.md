...
the [protocol
switch](https://datatracker.ietf.org/doc/html/rfc2616#section-14.42) mechanism available in HTTP/1.1 is used.
...
[](ngx_http_proxy_module.xml#proxy_read_timeout) directive.
