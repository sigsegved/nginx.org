...
Definitions of njs specific properties and methods not compliant with ECMAScript can be found in [Reference](reference.xml) . Definitions of njs properties and methods compliant with ECMAScript can be found in [ECMAScript specification](http://www.ecma-international.org/ecma-262/) .
...
- ES5.1 statements: `break` , `catch` , `continue` , `do while` , `else` , `finally` , `for` , `for in` , `if` , `return` , `switch` , `throw` , `try` , `var` , `while` ,
labeled statements ( [0.2.8](changes.xml#njs0.2.8) )
- ES6 statements: `let` ( [0.6.0](changes.xml#njs0.6.0) ), `const` ( [0.6.0](changes.xml#njs0.6.0) ), `async` ( [0.7.0](changes.xml#njs0.7.0) ), `await` ( [0.7.0](changes.xml#njs0.7.0) )
- `Math` properties:
...
- `Object` methods:
  - ES5.1: `create` (support without properties list), `defineProperties` (accessor descriptors support
since [0.3.3](changes.xml#njs0.3.3) ), `defineProperty` (accessor descriptors support
since [0.3.3](changes.xml#njs0.3.3) ), `freeze` , `getOwnPropertyDescriptor` , `getOwnPropertyDescriptors` ( [0.3.1](changes.xml#njs0.3.1) ), `getOwnPropertyNames` ( [0.3.1](changes.xml#njs0.3.1) ), `getPrototypeOf` , `isExtensible` , `isFrozen` , `isSealed` , `keys` , `preventExtensions` , `seal`
...
- `RegExp` ES9 named capture groups ( [0.3.2](changes.xml#njs0.3.2) )
