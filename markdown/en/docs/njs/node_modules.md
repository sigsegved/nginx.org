...
> **Note:** Examples in this article use features that appeared in [njs](index.xml) [0.3.8](changes.xml#njs0.3.8)
...
a library for creating and parsing protobuf messages used by the [gRPC](https://grpc.io/) protocol
- [dns-packet](https://www.npmjs.com/package/dns-packet) —
a library for processing DNS protocol packets

# Environment {#environment}

> **Note:** This document mostly employs a generic approach
...
njs [cli](cli.xml) in all examples for the sake of simplicity.
