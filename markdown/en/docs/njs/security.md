...
[here](https://github.com/nginx/njs/blob/master/SECURITY.md).
...
is to configure the
[js_import](../http/ngx_http_js_module.xml#js_import)
directive in nginx.
...
- if no [js_import](../http/ngx_http_js_module.xml#js_import)
