...
כדי להתקין את nginx/Windows, יש [להוריד](../../en/download.xml) את קובץ הזיפ של גירסת הפיתוח האחרונה , כיוון שענף הפיתוח מכיל את כל התיקונים הידועים, בייחוד אלו הקשורים לחלונות. אחרי ההורדה, יש לפרוס את קובץ הזיפ, להיכנס לתיקיה nginx- , ולהריץ את nginx. הנה דוגמא עבור תיקיית השורש של כונן C:
