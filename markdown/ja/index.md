...
nginx [えんじんえっくす] は [Igor Sysoev](http://sysoev.ru/en/) によって作られた HTTP とリバースプロキシのサーバで、メールプロキシサーバでもあります。 [Rambler](http://www.rambler.ru) ( [RamblerMedia.com](http://ramblermedia.com) ) を含むロシアの多くの高負荷サイトで５年以上も動いています。Netcraft によると、nginx は [2010 年 4 月時点で 4.70%](http://news.netcraft.com/archives/2010/04/15/april_2010_web_server_survey.html) の人気サイトでサーバーとして、もしくはプロキシとして利用されています。成功例としては [FastMail.FM](http://blog.fastmail.fm/2007/01/04/webimappop-frontend-proxies-changed-to-nginx/) や [Wordpress.com](http://barry.wordpress.com/2008/04/28/load-balancer-update/) があります。
