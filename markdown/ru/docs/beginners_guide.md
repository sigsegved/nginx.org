...
Если нет, см. [install.html](install.html).
...
можно найти в [control.html](control.html).
...
блок
[](http/ngx_http_core_module.xml#server)
внутри блока [](http/ngx_http_core_module.xml#http)
с двумя блоками [](http/ngx_http_core_module.xml#location).
...
`server`,
[различаемых](http/request_processing.html) по портам, на
которых они
[слушают](http/ngx_http_core_module.xml#listen),
и по
[имени сервера](http/server_names.html).
...
директивы [](http/ngx_http_core_module.xml#location),
...
Существует [множество](http/ngx_http_proxy_module.html)
...
и директив [](http/ngx_http_fastcgi_module.xml#fastcgi_param)
