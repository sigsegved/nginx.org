...
`nginx.conf` директивой
[](ngx_core_module.xml#pid).
Главный процесс поддерживает следующие сигналы:

> **Note:** | TERM, INT | быстрое завершение |
| --- | --- |
| QUIT | плавное завершение |
| HUP | изменение конфигурации,
...
(требует включения [](ngx_core_module.xml#debug_points)) |
...
суффикс `.oldbin` из имени файла с номером процесса.
