...
Поддерживаются следующие методы обработки соединений:
  ...
  > **Note:** Флаги `EPOLLRDHUP` (Linux 2.6.17, glibc 2.8)
и `EPOLLEXCLUSIVE` (Linux 4.5, glibc 2.24)
поддерживаются начиная с 1.11.3.

  > **Note:** В некоторых старых дистрибутивах, например SuSE 8.2,
