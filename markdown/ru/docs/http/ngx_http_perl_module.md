...
Модуль `ngx_http_perl_module` позволяет писать обработчики
...
> **Note:** Для сборки этого модуля необходим
[Perl](https://www.perl.org/get.html) версии 5.6.1 и выше.
...
[обновления сервера на лету](../control.xml#upgrade),
...
**`$r->log_error(код_ошибки,
сообщение)`**  
  записывает указанное *сообщение* в
