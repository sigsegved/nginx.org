...
Модуль `ngx_http_xslt_module` (0.7.8+) — это фильтр,
...
> **Note:** Для сборки и работы этого модуля нужны библиотеки
...
Директив xslt_param может быть несколько.
...
Директив xslt_string_param может быть несколько.
Директивы наследуются с предыдущего уровня конфигурации при условии, что
