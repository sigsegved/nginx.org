...
и определяют, в каком блоке [](ngx_http_core_module.xml#server)
будет обрабатываться тот или иной запрос.
См. также “[request_processing.html](request_processing.html)”.
...
в блоке [](ngx_http_core_module.xml#server), который не
...
Если директива
[](ngx_http_core_module.xml#server_name)
не задана в блоке [](ngx_http_core_module.xml#server),
...
в директиве [](ngx_http_core_module.xml#server_name)
...
поля Host заголовка запроса имя сервера не было выбрано,
то nginx будет использовать пустое имя в качестве имени сервера.
...
директивы [](ngx_http_ssl_module.xml#ssl_protocols)
...
и
[](ngx_http_core_module.xml#merge_slashes)
...
и
[](ngx_http_core_module.xml#underscores_in_headers),
...
директивы [](ngx_http_core_module.xml#error_page)
...
и [](ngx_http_core_module.xml#server_names_hash_bucket_size)
на уровне *http*.
