...
[пакеты](../linux_packages.html) с nginx.org.

## Установка на FreeBSD {#freebsd}

На FreeBSD можно установить nginx либо из
[пакетов](https://docs.freebsd.org/en/books/handbook/ports/#pkgng-intro),
либо с помощью системы
[портов](https://docs.freebsd.org/en/books/handbook/ports/#ports-using).
...
[configure.html](configure.html) освещает этот вопрос более подробно.
