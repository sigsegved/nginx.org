...
Начиная с версии [0.8.6](../njs/changes.xml#njs0.8.6)
...
Подробнее см. в разделе [Совместимость](compatibility.html).

## Движок QuickJS {#quickjs_engine}

[QuickJS](https://bellard.org/quickjs/) — компактный
встроенный движок JavaScript, который поддерживает
спецификацию [ES2023](https://tc39.es/ecma262/2023/),
...
- директива `js_preload_object` для
