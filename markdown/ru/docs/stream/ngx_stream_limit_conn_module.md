...
> **Note:** Дополнительно, как часть [коммерческой подписки](https://nginx.com/products/) , [информацию о состоянии](../http/ngx_http_api_module.xml#stream_limit_conns_) каждой такой зоны разделяемой памяти можно [получить](../http/ngx_http_api_module.xml#getStreamLimitConnZone) или [сбросить](../http/ngx_http_api_module.xml#deleteStreamLimitConnZoneStat) при помощи [API](../http/ngx_http_api_module.xml) начиная с версии 1.17.7.
