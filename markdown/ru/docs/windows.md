...
Чтобы установить nginx/Windows, [скачайте](../download.xml) дистрибутив последней основной версии ( ), поскольку основная ветвь nginx содержит все известные исправления. Затем распакуйте дистрибутив, перейдите в каталог nginx- и запустите `nginx` . Вот пример для корневого каталога на диске C:
